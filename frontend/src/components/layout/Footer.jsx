        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Discover amazing events and create unforgettable experiences. Join thousands of event lovers worldwide.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link to="/create-event" className="block text-gray-400 hover:text-white transition-colors">
                Create Event
              </Link>
              <Link to="/organizer-dashboard" className="block text-gray-400 hover:text-white transition-colors">
                Organizer Dashboard
              </Link>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@eventhive.com</span>
              </div>
              <div className="flex items-center space-x-3">
